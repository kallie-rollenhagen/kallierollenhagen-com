...
<div class="design-project-grid">
    ...
    <img class="design-img-first" src="{{ '/assets/images/Design-Wayside-all-covers.jpg' | url }}" alt="">
    <img class="design-img-stacked" src="{{ '/assets/images/Design-Wayside-green-mockup.jpg' | url }}" alt="">
    <img class="design-img-fullwidth" src="{{ '/assets/images/wayside_colors.png' | url }}" alt="">
    <img class="design-img-fullwidth" src="{{ '/assets/images/wayside_style_guide.jpg' | url }}" alt="">    