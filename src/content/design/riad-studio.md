...
title: RIAD Studio
slug: riad-studio
seoDescription: Brand development for interior design studio, RIAD Studio
publish: true
roles_played: Brand Development
credits:
  - role: Client
    person: Emily Schwamb, RIAD Studio
    url: https://www.riadstudio.com/
project_description: >-
  Brand development and visual identity for RIAD Studio, a boutique interior
  design firm.
  ...
  [RIAD Studio](https://www.riadstudio.com/) provides full-service residential design, from layout to finish. RIAD stands for Residential Interior Architectural Design. The name also refers to the traditional Moroccan riad — a home organized around an interior courtyard or garden, a structure reflected in the logo.
main_image:
  focal_x: 50
  focal_y: 50
...
thumbnail_image:
  focal_x: 50
  focal_y: 50
  file: /assets/images/design-riad-biz-cards.jpg
  alt: RIAD Studio business cards
gallery:
  lightbox: false
  rows:
    - object_fit: contain
      ...
      elements:
        ...
        - type: image
          focal_x: 50
          focal_y: 50
          file: /assets/images/moodboard-web-block-riad.jpg
          alt: Moodboard for RIAD Studio
    - object_fit: contain
      row_margin_bottom: large
      layout: right-wide
      elements:
    ...
    - object_fit: contain
      ...
      elements:
        - type: text
          text: The partial Figma mockup below shows how these brand elements can be
            applied to the RIAD Studio website. The website will primarily
            showcase RIAD Studio work, so the brand is designed to let imagery
      ...
      elements:
        - type: text
          text: <iframe style="border:none; width:100%; height:800px;"
            src="https://embed.figma.com/proto/zOsaTFR9L93X85MDkn8PF5/RIAD-Website-mockup?page-id=89%3A20&node-id=89-21&scaling=contain&content-scaling=fixed&starting-point-node-id=89%3A21&embed-host=share"
